   ...
   "use strict";
    ...
    angular.module('homeCtrl').controller('HomeController', ['$state',function($state){
      ...
      vm.cards = [
        ...
        {"id":"2", "type":"news-link", "icon":"fa-newspaper-o", "header":"News", "text":"Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."}
      ];
    }]);
